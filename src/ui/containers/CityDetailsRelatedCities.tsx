...
import { useGetRelatedCities } from "@/src/domains/city/operations/useGetRelatedCities";
...
export function CityDetailsRelatedCities({ id }: Props) {
  const { data: cities } = useGetRelatedCities(id); // recebe o data, e renomeia para cities(um apelido)
